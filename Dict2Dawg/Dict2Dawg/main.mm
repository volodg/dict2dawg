...
int last_dawg_converter( char* inFileNameWithDict ){
...
//	int FirstLineIsSize = 126383;//StringToPositiveInt(ThisLine);
   int FirstLineIsSize = 267750;///Users/vgor/sowpods.txt
	...
	ArrayDawgPtr Adoggy = ArrayDawgInit(AllWordsInEnglish, DictionarySizeIndex, MAX_MAX);
...
int main (int argc, const char * argv[])
{
   ...
   {
      NSLog(@"Hello, World!");
      last_dawg_converter( "/Users/vgor/sowpods.txt" );//, "/Users/vgor/sowpods1.bin" );
      //[ DDConverter run ];
//      [ DDConverter2 run ];
   }
   return 0;
