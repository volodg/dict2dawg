...
void write2text( int NumberOfLivingNodes, ArrayDawgPtr Result, const char* outFileNameWithDawgReport );
...
static ArrayDawgPtr ArrayDawgInit(char **Dictionary
                                  , int *SegmentLenghts
                                  , int MaxStringLength
   ...
   //Step 13
	write2binary( NumberOfLivingNodes, Result, outFileNameWithDawgBin );
   
   //Step 14
   write2text( NumberOfLivingNodes, Result, outFileNameWithDawgReport );
...
int dict2dawg_converter( const char* inFileNameWithDict
   ...
   long long FirstLineIsSize = line_counter( inFileNameWithDict );
	...
	//ArrayDawgPtr Adoggy = 
   ArrayDawgInit(AllWordsInEnglish
                 , DictionarySizeIndex
                 , MAX_MAX
                 , outFileNameWithDawgBin
                 , outFileNameWithDawgReport );
...
void write2binary( int NumberOfLivingNodes, ArrayDawgPtr Result, const char* outFileNameWithDawgBin )
{
	...
	FILE *Data;
	Data = fopen( outFileNameWithDawgBin,"wb" );
...
void write2text( int NumberOfLivingNodes, ArrayDawgPtr Result, const char* outFileNameWithDawgReport )
{
	...
	FILE *Text;
	Text = fopen(outFileNameWithDawgReport,"w");
